                    ...
                    <nav className="navbar py-2 bg-light">
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col">
                                    <select className="custom-select custom-select-sm" name="field" id="field">
                                        <option value="all" selected disabled hidden>Specify fields</option>
                                ...
                                <div className="col">
                                    <select className="custom-select custom-select-sm" name="ncbi_tax_id" id="ncbi_tax_id">
                                        <option value="-2"  selected disabled hidden>Specify organism...</option>
                                        <optgroup>
        ...
        return (
            <header>
                <nav className={["navbar navbar-expand-lg bg-light"].join( )}>
                    <a className={["navbar-brand mx-sm-5",style.brand].join(" ")} href="/">
                    ...
                    <form className="form-inline my-0 col-sm-6">
                        <div className="input-group my-1 col">
                            <input type="text" className="form-control" placeholder="Search" aria-label="Search" aria-describedby="searchBtn" />
