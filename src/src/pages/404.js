      ...
      <div className="row h-100 mt-3">
        ...
        <div className="col-sm-8 my-auto">
          ...
          <p>
            <b>Search Tips</b>
            <br />
            Our Search supports wildcards when performing searches. A wildcard
            is represented as an asterisk (*) and can appear anywhere in a
            search term. By default we use wildcard at head and tail, to improve
            the results.
            <br />
            The search edit distance is set as one, that means it can make 1
            change in the searched term to prevent typographic error.
            <hr />
            For example:
            <br />
            <br />
